...
| 3 | [Matching Agent](phase3-matching-agent.md) | In progress, review + QA pending | 6-type cross-employee/project/resource matching (supply-demand, resource, talent, investor, cross-project, mentor), confidence scoring, tracked runtime artifacts, and Feishu notification contracts |
